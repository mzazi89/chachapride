    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="uber-card text-center p-8">
          <div className="mx-auto mb-4 h-20 w-20 rounded-3xl bg-gradient-to-br from-blue-600 to-green-500 flex items-center justify-center text-4xl shadow-lg">
            🚗
          </div>
          <h1 className="text-2xl font-extrabold mb-1">Install chachapride</h1>
          <p className="text-gray-500 text-sm mb-6">
            Get the app on your phone or computer — faster to open, works like a real app.
          </p>
          ...
          {installed ? (
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 text-green-700 flex items-center justify-center gap-2">
              <FaCheckCircle /> chachapride is installed — open it from your home screen.
            </div>
          ) : (
            <button
              onClick={installNow}
          ...
          >
            ...
            {isIOS() ? (
              <ol className="space-y-2.5 text-sm text-gray-600 list-decimal list-inside">
                ...
                <li>
                  Tap <b>Add</b> (top right) — chachapride appears on your home screen.
                </li>
              </ol>
            ) : (
              <ol className="space-y-2.5 text-sm text-gray-600 list-decimal list-inside">
